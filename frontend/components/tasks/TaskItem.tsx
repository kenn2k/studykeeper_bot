...
import { BadgeX, Info, Pencil } from "lucide-react";
		...
		<>
			<h1 className="mt-10 text-lg font-bold p-2 rounded-t-lg text-[#C778DD] bg-[#2C2C2C] inline-flex items-center gap-2">
				...
				<div className="relative group">
					...
					<span className="hidden group-hover:flex absolute top-auto left-[-50] bg-[#333333] text-[#ECEFF4] text-xs px-2 py-2 rounded-md">
						Викладач: {teacher}
					</span>
				</div>
			</h1>
